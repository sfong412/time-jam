...
public class PlacedBlockShadow1 : MonoBehaviour
{
    Transform transform;
    ...
    void Start()
    {
        ...
        ink = GameObject.Find("Ink Bar").GetComponent<UIThings5>();
        gameplay = GameObject.Find("Gameplay Manager").GetComponent<Gameplay1>();
    ...
    void changeSprite()
    {
        ...
        switch (UIThings2.blockType)
        {
            ...
            case 10:
                transform.localScale = new Vector3(4f, 4f, 1f);
                transform.localRotation = Quaternion.Euler(0, 0, 0);
                spriteRenderer.sprite = goneBlock;
                break;
        }
    }
}
